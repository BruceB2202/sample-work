...
public class Organization {
    ...
    public int hashCode() {
        ...
        hash = 11 * hash + Objects.hashCode(this.organizationAddress);
        hash = 11 * hash + Objects.hashCode(this.organizationCity);
        hash = 11 * hash + Objects.hashCode(this.organizationState);
        hash = 11 * hash + Objects.hashCode(this.organizationPhone);
        hash = 11 * hash + Objects.hashCode(this.organizationEmail);
        return hash;
    }
