...
public class UserIOConsoleImpl implements UserIO {
    ...
    public BigDecimal readBigDecimal(String prompt){
        System.out.println(prompt);
        String userBDString = userInput.nextLine();
        BigDecimal userBD = new BigDecimal(userBDString);
        return userBD;
    ...
    public LocalDate readLocalDate(String prompt) {
        ...
        LocalDate userDate = LocalDate.parse(userDateString, DateTimeFormatter.ofPattern("MM/dd/yyyy"));
        return userDate;        
